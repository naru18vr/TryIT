...
| 高校英語文法：代名詞 | **進行中** | 最初の2トピック・正規動画4本を登録・検証済み |
...
直近の「訳に注意したい代名詞」2本は、Try IT公式のポイント・練習・チャレンジ、公開埋め込みID、カタログを照合済みである。一般の人を表す`you`・`we`・`they`、天気・時間・距離を表す`it`、特定の先行詞を指す用法との見分け方、自然な日本語訳を含むノートを登録し、`tQQZ3BzoEj8`の視聴ページで、YouTubeプレイヤー、要約、覚えるポイント、復習観点が表示されることを確認した。登録内容はSQLで2本とも動画別の必須語句・復習観点を含むことを確認し、2026-08-17時点でVitestは**6ファイル・24テストすべて成功**している。
...
高校英語文法「代名詞」は最初の2公式トピックを完了した。次は**「It is 時間」の慣用表現**を進め、その後に代名詞の残り、前置詞、形容詞・副詞、5文型、強調・倒置・挿入・省略・同格を進める。その後に、高校英語構文、高校理科、高校社会、高校国語を順に整備する。
...
> 次は高校英語文法「代名詞」の公式トピック、**「It is 時間」の慣用表現**を、Try IT公式根拠から1バッチ（通常2本）作成してください。カタログ照合・DB登録・表示確認・Vitest・進捗記録・保存・GitHub反映までを完結させ、品質基準を落とさずこの繰り返しを全動画まで続けることが最優先です。
