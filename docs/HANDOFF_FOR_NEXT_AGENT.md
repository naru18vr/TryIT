...
| 高校英語文法：代名詞 | **進行中** | 最初の7トピック・正規動画15本を登録・検証済み |
...
直近の「仮目的語のit」2本は、Try IT公式のポイント・練習・チャレンジ、公開埋め込みID、カタログを照合済みである。`find it 形容詞 to V`、`think it 形容詞 to V`、notを含むto V、`make it a rule to V`、`take it for granted that S V`、tookを含むノートを登録し、`DTCjdsRrd4g`の視聴ページで、YouTubeプレイヤー、要約、覚えるポイント、復習観点が表示されることを確認した。登録内容はSQLで2本とも動画別の必須語句・復習観点を含むことを確認し、2026-08-17時点でVitestは**6ファイル・24テストすべて成功**している。
...
高校英語文法「代名詞」は最初の7公式トピックを完了した。次は**that／thoseの使い方**を進め、その後に代名詞の残り、前置詞、形容詞・副詞、5文型、強調・倒置・挿入・省略・同格を進める。その後に、高校英語構文、高校理科、高校社会、高校国語を順に整備する。
...
> 次は高校英語文法「代名詞」の公式トピック、**that／thoseの使い方**を、Try IT公式根拠から1バッチ（通常2本）作成してください。カタログ照合・DB登録・表示確認・Vitest・進捗記録・保存・GitHub反映までを完結させ、品質基準を落とさずこの繰り返しを全動画まで続けることが最優先です。
